            ...
            <div class="row ">
               <div class="col-lg-9 my-order-switch-1 ">
                     ...
                     <div class="row ">
                        ...
                        <div class="col-lg-4   mb-5">
                           <div class="item web">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-overlay="rgba(52,58,64,.6)" href="assets/img/portfolio/2.jpg">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/2.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4   mb-5">
                           <div class="item graphic">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-overlay="rgba(52,58,64,.6)" href="assets/img/portfolio/3.jpg">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/3.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5">
                           <div class="item web">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-overlay="rgba(52,58,64,.6)" href="assets/img/portfolio/4.jpg">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/4.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4   mb-5">
                           <div class="item graphic">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-overlay="rgba(52,58,64,.6)" href="assets/img/portfolio/5.jpg">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/5.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5">
                           <div class="item web">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-overlay="rgba(52,58,64,.6)" href="assets/img/portfolio/6.jpg">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/6.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5">
                           <div class="item motion">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-vbtype="video" data-overlay="rgba(52,58,64,.6)" href="https://youtu.be/8YDd8Wgjj28">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/7.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4  mb-5">
                           <div class="item graphc">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-overlay="rgba(52,58,64,.6)" href="assets/img/portfolio/8.jpg">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/8.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5">
                           <div class="item graphic">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-overlay="rgba(52,58,64,.6)" href="assets/img/portfolio/9.jpg">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/9.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0">
                           <div class="item graphic">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-overlay="rgba(52,58,64,.6)" href="assets/img/portfolio/10.jpg">
                                 <span class="hover-effect-container">
                                 <span class="hover-effect-icon ">
                                 <span class=" fas fa-eye top-icon "></span>
                                 </span>
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/10.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4   mb-5 mb-lg-0">
                           <div class="item motion">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-vbtype="video" data-overlay="rgba(52,58,64,.6)" href="https://youtu.be/8YDd8Wgjj28">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/11.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                        ...
                        <div class="col-lg-4">
                           <div class="item motion">
                              <a class="radius-1 shadow-inner venobox hover-effect d-block vbox-item" data-vbtype="video" data-overlay="rgba(52,58,64,.6)" href="https://youtu.be/8YDd8Wgjj28">
                                 ...
                                 <div class="  p-2  ">
                                    <div class="shadow radius-1">
                                       <img class=" radius-1" alt="" src="assets/img/portfolio/12.jpg">
                                    </div>
                                 </div>
                              </a>
                           </div>
                           ...
                           <a class="float-md-right" href="#">
                              <div class="media  align-items-center">
                                 <div class="outer radius-2  mr-3">
                                    <div class="ui-icon ui-icon-md inner ">
                                       <div class="ui-icon-inner">
                                          <svg version="1.1" class="max-width-1-3 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                             viewBox="0 0 518 518" enable-background="new 0 0 518 518;" xml:space="preserve">
                                             <g>
                                                <g>
                  ...
                  <section id="blog" class="shadow bg-dark radius-2 padding-dy ">
                     <div class="row mb-5">
                        <div class="col">
                           <h6 class="font-weight-700  mb-0 text-uppercase mb-2">Latest News</h6>
                           <hr class="divider divider-left divider-lg float-left">
                        </div>
                     </div>
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <div class="outer radius-2 d-inline-block">
                              <a href="#home" class="inner radius-2 d-block px-4 py-2 font-size-14 text-alt font-weight-500">
                              Read more
                              </a>
                           </div>
                        </div>
                                    ...
                                    <div class="media  align-items-center">
                                       <div class="radius-5 mr-4 d-none d-lg-block">
                                          <div class="shadow-inner  ui-icon ui-icon-xl ui-icon-xxl">
                                             <div class="ui-icon-inner">
                                                <svg version="1.1" class="max-width-3 stroke-12 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                   viewBox="0 0 353.3 240.7" enable-background="new 0 0 353.3 240.7;"  xml:space="preserve">
                                                   <g>
                     ...
                     <div class="row mt-6">
                        <div class="col text-center">
                           <div class="outer radius-2 d-inline-block">
                              <a class="inner radius-2 d-block px-4 py-2 font-size-15 font-weight-500" href="blog.html">
                              View all blog posts
                              </a>
                           </div>
                        </div>
                           ...
                           <div class="w-75 m-auto ">
                              <div class="radius-5">
                                 <div class="shadow-inner  ui-icon ui-icon-xl ui-icon-lg-2 ">
                                    <div class="ui-icon-inner">
                                       <svg version="1.1" class="max-width-2-7 svg-icon stroke-0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                          viewBox="0 0 61 61.1" enable-background="new 0 0 61 61.1;" xml:space="preserve">
                                          <g>
                                             <path  d="M30.5,26.5c3.9,0,7-3.1,7-7s-3.1-7-7-7s-7,3.1-7,7S26.7,26.5,30.5,26.5z M30.5,14.5c2.8,0,5,2.2,5,5
                                                s-2.2,5-5,5s-5-2.2-5-5S27.8,14.5,30.5,14.5z"/>
                                             <path  d="M30.3,55.3l15.3-22.2c5.8-7.7,4.9-20.3-1.8-27c-3.5-3.6-8.3-5.6-13.5-5.6s-9.9,2-13.6,5.6
                                                c-6.7,6.7-7.5,19.3-1.8,27L30.3,55.3z M18.3,7.5c3.2-3.2,7.6-5,12.1-5s8.9,1.8,12.2,5c6,6,6.8,17.4,1.6,24.4L30.3,51.8L16.7,31.9
                                                C11.4,25.1,12.2,13.7,18.3,7.5z"/>
                                             <path d="M42.6,43.5c-0.5-0.1-1,0.3-1.1,0.9s0.3,1,0.9,1.1c10.5,1.2,16.1,4.6,16.1,6.5c0,2.7-10.7,6.5-28,6.5
                                                s-28-3.8-28-6.5c0-1.9,5.6-5.3,16.1-6.5c0.5-0.1,0.9-0.6,0.9-1.1c-0.1-0.5-0.6-0.9-1.1-0.9C8,44.8,0.5,48.3,0.5,52.1
                                                c0,4.2,10.3,8.5,30,8.5s30-4.3,30-8.5C60.5,48.3,53.1,44.8,42.6,43.5z"/>
                                          </g>
                                       </svg>
                                    </div>
                                 </div>
                              </div>
                              <h2 class="h5 font-size-18 text-center font-weight-600 mt-4">The Company Name Inc.1234 Street Road<br>
                           ...
                           <div class="  text-center">
                              <div class="radius-5">
                                 <div class="shadow-inner  ui-icon ui-icon-lg ">
                                    <div class="ui-icon-inner">
                                       <svg version="1.1" class="max-width-1-7 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                          viewBox="0 0 517 397.6" enable-background="new 0 0 517 397.6;" xml:space="preserve">
                                          <g>
                                             <g>
                                                <g>
                              ...
                              <p class="text-alt mb-0 mt-3 font-size-14 shadow-inner radius-2 px-3 py-1">Email : name@gmail.com </p>
                           </div>
                        </div>
                        <div class="col-md-4 mb-3 mb-lg-0">
                           <div class="  text-center">
                              <div class="radius-5">
                                 <div class="shadow-inner  ui-icon ui-icon-lg ">
                                    <div class="ui-icon-inner">
                                       <svg version="1.1" class="max-width-1-7 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                          viewBox="0 0 517.1 517" enable-background="new 0 0 517.1 517;" xml:space="preserve">
                              ...
                              <p class="text-alt mb-0 mt-3 font-size-14 shadow-inner radius-2 px-3 py-1">Phone : (513) 352-3209 </p>
                           </div>
                        </div>
                        <div class="col-md-4 mb-3 mb-lg-0">
                           <div class="  text-center">
                              <div class="radius-5">
                                 <div class="shadow-inner  ui-icon ui-icon-lg ">
                                    <div class="ui-icon-inner">
                                       <svg version="1.1" class="max-width-1-7 svg-icon stroke-0" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 517 517" enable-background="new 0 0 517 517;" xml:space="preserve">
                                          <g>
                                             <g>
                                                <path  d="M258.5,2.5c-141.4,0-256,114.6-256,256s114.6,256,256,256s256-114.6,256-256S399.9,2.5,258.5,2.5z
                                                   M174.7,44.1c-24.9,27.1-44.7,66.1-56.8,112H52.2C77.7,105.2,121.4,65,174.7,44.1z M28.1,258.5c0-27,5.1-52.7,13.7-76.8h70.5
                              ...
                              <p class="text-alt mb-0 mt-3 font-size-14 shadow-inner radius-2 px-3 py-1">Site : www.yoursite.com</p>
                           </div>
                        </div>
                     </div>
                     <div class="row mb-5 mt-6">
                        ...
                        <div class="col-md-12">
                           <form class="contact-form" method="post" action="send.php">
                              <div class="row">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="outer radius-2 mb-3">
                                       <input  class="inner form-control  h-100 " value="" id="compagny" name="compagny" placeholder="Compagny" type="text">
                                    </div>
                                 </div>
                                 <div class="col-sm-6">
                                    <div class="outer radius-2 mb-3">
                              ...
                              <li class="outer radius-2 mb-3">
                                 <a class="inner radius-2" href="#about" >
                                    <div class="media  align-items-center ">
                                       ...
                                       <svg version="1.1" class="max-width-1 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                          viewBox="0 0 512 514.5" enable-background="new 0 0 512 514.5;" xml:space="preserve">
                                          <g>
                                             <g>
                                 ...
                                 <a class="inner radius-2" href="#portfolio" >
                                    <div class="media  align-items-center ">
                                       ...
                                       <svg class="max-width-1 svg-icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                          viewBox="0 0 517 414.6" enable-background="new 0 0 517 414.6;" xml:space="preserve">
                                          <g>
                                             <g>
                              ...
                              <li class="outer radius-2 mb-3">
                                 <a class=" inner radius-2" href="#contact" >
                                    <div class="media  align-items-center ">
                                       ...
                                       <svg version="1.1" class="max-width-1 svg-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                          viewBox="0 0 514 411.6" enable-background="new 0 0 514 411.6;" xml:space="preserve">
                                          <g>
                                             <g>
